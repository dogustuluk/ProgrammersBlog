...
namespace ProgrammersBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        {
            /*Eğer folderName değişkeni null gelir ise, o zaman resim tipine göre(PictureFile) klasör adı ataması yapılır.*/
             ...
             */
            string newFileName = $"{name}_{dateTime.FullDateAndTimeStringWithUnderscore()}{fileExtension}"; // ---->DoğuşTuluk_587_5_38_12_3_10_2020.png
