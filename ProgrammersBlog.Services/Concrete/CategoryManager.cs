...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ManagerBase,ICategoryService
    {
        ...
        public async Task<IDataResult<CategoryDto>> AddAsync(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            var addedCategory = await UnitOfWork.Categories.AddAsync(category);//saveasync'i continueWith ile yaparsak thread'lerde hata alıyor olucaz.
        ...
        public async Task<IDataResult<CategoryUpdateDto>> GetCategoryUpdateDtoAsync(int categoryId)
        {
            ...
            if (result)
            {
                var category = await UnitOfWork.Categories.GetAsync(c => c.Id == categoryId); //category'i artık CategoryUpdateDto'ya map etmemiz gerekiyor.AutoMapper Profile'a ekle. ->            CreateMap<Category, CategoryUpdateDto>();
