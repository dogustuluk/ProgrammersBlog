...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager : ICategoryService
    {
        ...
        public async Task<IResult> Add(CategoryAddDto categoryAddDto, string createdByName)
        {
            ...
            await _unitOfWork.Categories.AddAsync(category).ContinueWith(t => _unitOfWork.SaveAsync()); //bu işlem daha veri tabanına kaydedilmeden biz frontend kısmına dönmüş olmamız mümkün olacak. performans kazandırırken yönetimini zorlaştırıyor olacak.
